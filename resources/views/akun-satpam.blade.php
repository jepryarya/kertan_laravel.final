...
<body>
  ...
  <div id="sidebarProfile" class="sidebar-profile" aria-hidden="true" aria-label="Sidebar Profil">
    ...
    <a href="{{ route('form.satpam') }}" class="menu-item">Tambah Data Satpam</a>
  ...
  <div class="container mt-5" style="max-width: 500px;">
    <h3 class="mb-4 text-primary">Form Daftar Akun Satpam</h3>
    ...
    <form action="{{ route('akun.satpam.simpan') }}" method="POST">
      @csrf
      <div class="mb-3">
    ...
    <a href="{{ route('form.satpam') }}" class="btn btn-secondary w-100 mt-3">Isi Data Satpam</a>
  </div>
