...
public function beranda()
{
    ...
    // Data warga dan satpam
    $warga = Warga::all();
    $satpam = Satpam::select('nama', 'no_hp', 'shift')->get();

    // Hitung notifikasi
    $notifPengajuan = PengajuanSurat::where('status', 'menunggu')->count();
    $notifPengaduan = Pengaduan::where('status', 'belum_ditindaklanjuti')->count();
    $notifTamu = Tamu::whereDate('created_at', now()->toDateString())->count();
